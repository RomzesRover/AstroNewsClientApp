...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_dividerPaddingSliding, dividerPadding);
		...
		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_textAllCapsSliding, textAllCaps);
