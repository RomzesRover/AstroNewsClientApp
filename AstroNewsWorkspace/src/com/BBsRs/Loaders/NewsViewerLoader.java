...
public class NewsViewerLoader {
	...
	SharedPreferences sPref;    										//для настроек
																		//конструктор
	public NewsViewerLoader(Context context,GridView view, ProgressBar progressBar,View v,DisplayImageOptions options,RelativeLayout errLt){
		...
		thr=new Thread(new Runnable() {				//������ � ����� ������
	        public void run() {
	        	try {
					...
					doc =  Jsoup.connect("http://www.astronews.ru/cgi-bin/mng.cgi?page=news&str="+String.valueOf(pageN))
