...
public class QuestionsViewerAdapter extends BaseAdapter {

	 	ArrayList<NewsBaseInfoArray> videoBaseInfoArray = new ArrayList<NewsBaseInfoArray>();
	    LayoutInflater inflater;
	    DisplayImageOptions options;
	    ImageLoader imageLoader;
	    public QuestionsViewerAdapter(Context context, ArrayList<NewsBaseInfoArray> videoBaseInfoArray,DisplayImageOptions options, ImageLoader imageLoader) {
	    ...
	    public View getView(final int position, View convertView, ViewGroup parent) {
	        ...
	        if (rowView == null) {
	            rowView = inflater.inflate(R.layout.ic_element_simple_questions, parent, false);
